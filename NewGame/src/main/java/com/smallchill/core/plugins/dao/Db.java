...
public class Db {
	...
	*/
	...
	@SuppressWarnings("rawtypes")
	public static BladePage<Map> paginateBySelf(String sqlTemplate, String sqlCount, Object paras, int pageNum, int pageSize){
		return getDbManager().paginateBySelf(sqlTemplate, sqlCount, paras, pageNum, pageSize);
	}
