...
public class SqlKeyword {
	...
	private static final String DATE_GTE = "_dategte";
	private static final String DATE_LTE = "_datelte";
	private static final String NUM_GT = "_numgt";
	private static final String NUM_LT = "_numlt";
	...
	static {
		...
		keyWord.put(DATE_GT, " > ? ");
		keyWord.put(DATE_LT, " < ? ");
		keyWord.put(DATE_GTE, " >= ? ");
		keyWord.put(DATE_LTE, " <= ? ");
		keyWord.put(NUM_GT, " >= ? ");
		keyWord.put(NUM_LT, " <= ? ");
