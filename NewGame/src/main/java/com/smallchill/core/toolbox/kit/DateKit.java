...
public class DateKit {
	...
	private final static SimpleDateFormat sdfYearDays = new SimpleDateFormat("yyMMdd");
	...
	public static String getMsTimeToString(String d) {
		return sdfmsTime.format(d);
	}
	...
	public static String getTimeBySSS(Date date) {
