 ...
 * 
 * import com.concom.security.infrastructure.shiro.ShiroRealm; import
 * com.concom.security.infrastructure.shiro.cache.ShiroCacheManager; import
 * com.smallchill.core.shiro.ShiroDbRealm;
 * 
 *//**
	 * @author Dylan
	 * @time 2014年1月8日
 ...
 * if(log.isDebugEnabled()){ log.debug("clear the " + username +
 * " authorizationInfo"); } //ShiroCasRealm.authorizationCache
 * 为shiro自义cache名(shiroCasRealm为我们定义的reaml类的类名) Cache<Object, Object> cache =
 * cacheManager.getCache(ShiroDbRealm.REALM_NAME+".authorizationCache");
 ...
 *//**
	 ...
	 *//*
		 ...
		 * if(log.isDebugEnabled()){ log.debug("clear the session " + JSESSIONID); }
		 ...
		 * 
		 * public static ShiroCacheManager getCacheManager() { return cacheManager; }
		 * 
