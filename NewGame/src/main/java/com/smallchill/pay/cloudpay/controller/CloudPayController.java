package com.smallchill.pay.cloudpay.controller;
...
@RestController
@RequestMapping("/pay/CloudPay")
public class CloudPayController extends BaseController implements ConstShiro {
    ...
    private AjaxResult rechargeGalaxy(RechargeRecords rechargeRecords, JSONObject resultMap, Map<String,Object> channel) {
        ...
        String response = CloudPayUtils.recharge(rechargeRecords,cloudPay,channel);
        if ("".equals(response)) {
