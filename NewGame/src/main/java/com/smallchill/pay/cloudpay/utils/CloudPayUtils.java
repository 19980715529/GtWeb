package com.smallchill.pay.cloudpay.utils;
...
public class CloudPayUtils {
    private static final Logger LOGGER = LogManager.getLogger(CloudPayUtils.class);


    public static String recharge(RechargeRecords rechargeRecords, CloudPay cloudPay, Map<String, Object> channel){
        String response;
        HashMap<String, Object> map = new HashMap<>();
        // 商户号
        map.put("merchant", cloudPay.getMerchant());
        // 支付类型
        ...
        //
        String sign = Utils.getSign(map, cloudPay.getKey());
        map.put("sign", sign);
