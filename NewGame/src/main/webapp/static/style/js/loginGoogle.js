...
$(function () {
    ...
    $("#sendcode").click(function () {
        ...
        if(account ==null||account ==""){
            ...
            $.ajax({
                url:BladeApp.ctxPath +"/google/generateGoogleSecret",
                type:'get',
                dataType:'json',
                ...
                success:function (data) {
                    if(data.code === 0){
                    	console.log(data);
                    	$("#hash").val(data.data.secret);
                    	var html = '<img src="'+BladeApp.ctxPath +'/google/genQrCode?secretQrCode='+data.data.secretQrCode+'"/>';
                    	layer.confirm(html, {
                		  title:'扫码二维码获取验证码',
                		  btn:['关闭']
                		});
