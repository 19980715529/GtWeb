		...
		<div class="form-group">
			<div class="col-sm-8">
				@if(value != "" && strutil.contain(value,"http")){
				<image id="${id}_IMG" src="${value}" data-auto="${auto}" style="padding:2px; border:1px solid #ccc;cursor:pointer;width:${width!'170px'};height:${height!'110px'};"></image>
				@} else {
