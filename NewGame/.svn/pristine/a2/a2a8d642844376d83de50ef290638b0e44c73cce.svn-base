	...
	<textarea id="${id}" name="${_token}${name}" ${required!} class="form-control" cols="100" rows="8" style="visibility:hidden;width:${width!'100%'};height:${height!'200px'};">${value!}</textarea>
